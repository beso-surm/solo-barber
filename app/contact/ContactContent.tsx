      ...
      <section className="mx-auto grid max-w-[1100px] grid-cols-[repeat(auto-fit,minmax(320px,1fr))] items-start gap-12 px-7 pt-[60px] pb-[110px]">
        <Reveal className="flex flex-col gap-8">
          ...
          <div className="mt-2 flex flex-wrap gap-3.5">
            <Button href={CONTACT.whatsappHref} icon={<IconWhatsApp className="h-4 w-4" />}>
              WhatsApp
            </Button>
            <Button href={CONTACT.instagramHref} variant="secondary" magnetic={false} icon={<IconInstagram className="h-4 w-4" />}>
              Instagram
            </Button>
          </div>
        </Reveal>
